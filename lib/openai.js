export class OpenAIService {
    ...
    async generateResponse(messages, context = null) {
        ...
        // Only include transcript if explicitly provided (not null)
...
(Note: Transcript may be truncated)`
            ...
            console.log('[OpenAI] System message with transcript added', {
            ...
            if (context === '') {
                ...
                console.log('[OpenAI] No context provided (transcript already sent or not available)');
            }
        }
